...
namespace UnityETP.DataAccess.Abstract
{
        ...
        where TEntity : IBaseEntity<TPrimary>
    {
        ...
        Task<TEntity> GetFristAsync(Expression<Func<TEntity, bool>> predicate = null, bool isNotSelectSoftDelete = true, params Expression<Func<TEntity, object>>[] includeProperties);

        Task<TEntity> GetLastAsync(Expression<Func<TEntity, bool>> predicate = null, bool isNotSelectSoftDelete = true, params Expression<Func<TEntity, object>>[] includeProperties);
